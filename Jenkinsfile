            ...
            steps {
                sshagent(['jenkinaccess']) {
                    script {
                        ...
                        trivy image --format template --template "/opt/docker-green/Trivy/trivy-template.tpl" --output "/opt/docker-green/Trivy/frontend-demo-722-scanning.md" "arunthopil/pro-green-v2-frontend:demo-722"
                        '
                        """
