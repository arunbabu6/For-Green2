pipeline {
    ...
    stages {
        ...
        stage('Snyk Security Scan') {
            ...
            steps {
                dir('client') {
                snykSecurity failOnError: false, failOnIssues: false, organisation: 'arunbabu6', projectName: 'For-Green2-new', snykInstallation: 'Snyk', snykTokenId: 'snyk-token', targetFile: 'package.json'
                }
